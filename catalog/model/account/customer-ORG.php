...
class ModelAccountCustomer extends Model {
	public function addCustomer($data) {
		...
		$message = sprintf($this->language->get('text_welcome'), html_entity_decode($this->config->get('config_name'), ENT_QUOTES, 'UTF-8')) . "<br /><br />";
		...
		$message .= $this->url->link('account/login', '', true) . "<br />";
		$message .= $this->language->get('text_services') . "<br />";
    ...
    <a href="mailto:info@your-plate.de" target="_blank">E-Mail: info@your-plate.de</a><br />

    Gesch&auml;ftsf&uuml;hrer: Yalcin Avci<br />
  ...
  ';
		...
		if (in_array('account', (array)$this->config->get('config_mail_alert'))) {
			...
			$message .= $this->language->get('text_website') . ' ' . html_entity_decode($this->config->get('config_name'), ENT_QUOTES, 'UTF-8') . "<br />";
