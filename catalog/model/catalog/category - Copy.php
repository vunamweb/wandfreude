...
class ModelCatalogCategory extends Model {
    ...
    public function getFirstProductOfCategory($category_id) {
	   $sql = "select product_id from " . DB_PREFIX . "product_to_category where category_id = ".$category_id."";
       $query = $this->db->query($sql);
       $query = $query->rows;
    ...
    public function getCategoriesPlate($parent_id = 0) {
        ...
        foreach($categories as $category){
            $query = $this->db->query("SELECT product_id FROM " . DB_PREFIX . "product_to_category p where p.category_id = ".$category[category_id]."");
