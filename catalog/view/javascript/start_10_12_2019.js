...
class DrawImage {
    ...
    checkShowImageWidth() {
       if(parseInt($('#width1').val()) < this.minWidth || parseInt($('#width2').val()) < this.minWidth || parseInt($('#width3').val()) < this.minWidth )
	       ...
	       if(parseInt($('#height1').val()) > this.maxWidth1500)
	       		return 'Das Höchstmaß beträgt 1500 mm x 3000 mm';
    ...
    checkShowImageHeight() {
       if(parseInt($('#height1').val()) < this.minWidth)
	       ...
	       return 'Das Höchstmaß beträgt 3000 mm';
	   		...
	   		if(parseInt($('#width1').val()) > this.maxWidth1500 || parseInt($('#width2').val()) > this.maxWidth1500 || parseInt($('#width3').val()) > this.maxWidth1500 )
	       		return 'Das Höchstmaß beträgt 1500 mm x 3000 mm';
	       	else return 1;
       }
...
$(document).ready(function(){
  ...
  $('.drawimage :input').on('input',function(e){
    warn = drawImage.checkShowImageWidth();
    checkFill = true;
    if(warn==1) {
      drawImage.setValuePlate();
      drawImage.showImageChangeWidth();
...
*/
  ...
  $('.radio input:radio').change(function(){
    var addition = parseInt($(this).attr('price').replace('$','').replace('Ã¢â€šÂ¬',''));
    value = (value == null) ? parseInt($('.price-product li span').html().replace('$','').replace('Ã¢â€šÂ¬','')) : value;
    var newValue = addition + value;
    $('.price-product li span').html('Ã¢â€šÂ¬'+newValue+'');
  })
