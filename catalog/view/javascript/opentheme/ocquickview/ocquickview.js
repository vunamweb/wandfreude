...
var ocquickview = {
		...
		$(divContain + ' a').each(function() {
			...
			if(hasImg == 1) {
				...
				if(isExist != 1) {
					...
					divContainer.find('.' + childrenEle).append('<a class="qv-button-container" title="' + text_quickview + '" data-toggle="tooltip"><button class="btn-quickview" type="button"><i class="fa fa-eye" aria-hidden="true"></i><span>' + text_quickview + '</span></button></a>');
	...
	'closeQVFrame' : function () {
		...
		$('div.quickview-container a').hide();
