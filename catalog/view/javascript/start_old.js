...
class DrawImage {
    constructor(canvas,image){
        ...
        this.spaceX = 2;
        this.spaceY = 2;
        this.defaultHeightPlate = 1800;
        this.defaultWidthPlate = 1000;
    ...
    getHeightcanvas(){
        ...
        if(width < height)
          ...
          return this.getWidthAreaDraw()/width * height;    
    }
    ...
    setImgUseTimthumb(){
       ...
       const newSrc = 'timthumb.php?src='+src+'&w='+width+'&zc=1';
       
       dom1.attr('src',newSrc);
       dom.attr('src',newSrc);
    }
    ...
    horizontalDirection(){
            ...
            for(i = 0; i < numberPlates; i++){
                ...
                //marginLeftPlate = marginLeftPlate + dWidth;
...
$(document).ready(function(){
  ...
  $('.button-cut').click(function(){
    ...
    setTimeout(function(){ new Crop($('#sourcez')).cutOut();}, 1000);
  })
