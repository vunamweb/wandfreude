    ...
    <div class="col-1 col-sm-5">
		...
		<div class="col-2 col-sm-7">
          ...
          <div class="form-group">
				...
				<input type="button" id="plus" value="&#43;" class="form-control"/><br/>
				<button class="button" type="button" id="button-cart2" data-loading-text="<?php echo $text_loading; ?>"><i class="fa fa-shopping-basket"></i><span><?php echo $button_cart; ?></span></button>
				<button class="btn-wishlist" type="button" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="addWishlist('<?php echo $product_id; ?>');"><i class="fa fa-heart-o"></i></button>
				<button class="btn-compare" type="button" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="addCompare('<?php echo $product_id; ?>');"><i class="fa fa-signal"></i></button>
			</div>
			<div class="addthisbtn">
			  <!-- AddThis Button BEGIN -->
            <div class="addthis_toolbox addthis_default_style" data-url="<?php echo $share; ?>"><a class="addthis_button_facebook_like" fb:like:layout="button_count"></a> <a class="addthis_button_tweet"></a> <a class="addthis_button_pinterest_pinit"></a> <a class="addthis_counter addthis_pill_style"></a></div>
            <script>
				var script = '//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-515eeaf54693130e';
				if (window.addthis) {
					window.addthis = null;
					window._adr = null;
					window._atc = null;
...
<script type="text/javascript">
	...
	if(body_class.search('product-product') != -1) {
		$('.addthisbtn').hide();
	}else {
		$('.addthisbtn').show();
	}
//<![CDATA[
    ...
    $('#button-cart2').on('click', function() {
      $.ajax({
        ...
        type: 'post',
        data: $('input[name=\'product_id\'], #input-quantity, #product2 input[type=\'text\'], #product2 input[type=\'hidden\'], #product2 input[type=\'radio\']:checked, #product2 input[type=\'checkbox\']:checked, #product2 select, #product2 textarea'),
        dataType: 'json',
        beforeSend: function() {
