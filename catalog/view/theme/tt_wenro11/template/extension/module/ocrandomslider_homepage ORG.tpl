    ...
    <div class="product-layout product-grid layout2">
							  <div class="product-thumb">
								  ...
								  <?php if($product['category_id'] != ''){?>
                                     <a href="product/<?php echo $product['product_id']; ?>/<?php echo $product['category_id']; ?>/<?php echo $_GET['number_plate'] ?>/2">
								  <?php if ($product['thumb']) { ?>
									<img  src="image/<?php echo $product['url_image']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-responsive lazy" />
