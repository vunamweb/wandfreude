        ...
        <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
            <div class="custom-category quickview-added qv-wtext">
                ...
                <div class="toolbar row">
					<div class="col-12 col-md-4 toolbar3">
                        <div class="btn-group">
                            <button type="button" id="list-view" class="btn btn-default"><i class="fa fa-th-list"></i></button>
                            <button type="button" id="grid-view" class="btn btn-default"><i class="fa fa-th"></i></button>
                        </div>
                    </div>
                    <div class="col-6 col-md-4 toolbar1 pull-right">
                    ...
                    <div class="col-6 col-md-4 toolbar2 pull-right">
                ...
                <div class="custom-products">
                    ...
                    <?php foreach ($products as $product) { ?>
                        <div class="col-12 col-md-4 product-list ">
                          <div class="product-thumb layout1">
							<div class="image">
                              ...
                              <?php if ($product['thumb']) { ?>
                                <img   src="<?php echo $product['thumb']; ?>" data-original="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-responsive lazy" />
                            ...
                            <div class="product-inner">
							  ...
							  <?php if ($product['tags']) { ?>
									  ...
									  <?php } ?>
							   <?php if (isset($product['ratingXXXX'])) { ?>
                                  <div class="ratings">
							 ...
							 <?php if ($product['price']) { ?>
								...
								<p class="product-des"><?php echo nl2br($product['description']); ?></p>
