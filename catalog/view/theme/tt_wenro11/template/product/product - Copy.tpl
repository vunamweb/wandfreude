        ...
        <div class="col-2 col-sm-3">
		   <div id="height">
			...
			<div class="number_plates">
			  <p>Your Plates</p>
			  <div class="plate_1 padding_plates">1</div>
			  <div class="plate_2 padding_plates">2</div>
			  <div class="plate_3 padding_plates">3</div>
			</div>
  ...
  <div class="form-group hide">
        ...
        <select class="form-control" id="anzahlPlatten">
		  ...
		  <div class="form-group">
				...
				<br /> !-->
				<button class="button" type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>"><i class="fa fa-shopping-basket"></i><span><?php echo $button_cart; ?></span></button>
			</div>
		</div>
		<div class="col-1 col-sm-6 drawimage">
          <div style="float: left;position: relative;">
			  ...
			  <div class="top-canvas">
			     <input type="button" value="AUSSCHNIT WAHLEN" class="button-cut" data-toggle="modal" data-target="#myModal" />
			     <input type="button" value="MOTIV SPIEGELN" class="change-direction"/>
			  </div>
