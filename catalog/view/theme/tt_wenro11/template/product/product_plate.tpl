...
<div class="container">
  <div class="row"><?php echo $column_left; ?>
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } ?>
    <div id="content" class="<?php echo $class; ?>" style="margin-top:-30px;"><?php echo $content_top; ?>
      <div class="row">
        <?php if ($column_left || $column_right) { ?>
        <?php $class = 'col-sm-6'; ?>
        <?php } else { ?>
		   ...
		   <div class="row">
			   ...
			   <div class="col-xl-12 col-lg-12 col-sm-6">
					...
					<div class="number_plates ">
						<p class="schritte mb0">Schritt 2: Wählen Sie die</p>
					  	<p><strong>ANZAHL Rückwände</strong></p>
			   ...
			   <div class="col-xl-12 col-lg-12 col-sm-6">
					<div class="w_radio clearfix rahmen">
						<p class="schritte mb0">Schritt 3:</p>
		                <p><strong>MATERIAL AUSWAHL</strong></p>
								<?php foreach($material as $item) { ?>
								  ...
								  <a  data-toggle="tooltip" data-html="true" title="<?php echo $item['answer'] ?>"><i class="fas fa-info-circle"></i></a>
								  </div>
								<?php } ?>
								
					<!--	<div class="alert alert-danger text-left"><b>Alu-Premium Matt/Nano</b><br/>- ab Mitte April wieder verfügbar.<br/><br/>
						<b>Alu- Premium UV-Hochglanz</b><br/>- ab Mitte April wieder verfügbar.</div>-->
					</div>
			   </div>
			   ...
			   <div class="col-xl-12 col-lg-12 col-sm-6">
					<div class="rahmen">
						<p class="schritte mb1">Schritt 4: Maße</p>
						<a data-toggle="tooltip" data-html="true" title="" data-original-title="<p><?php include("./include/25.php"); ?></p>"><i class="masse"><i class="fa fa-warning orange"></i> Wichtiger Hinweis zu den Maßen!</i></a>

					</div>

					<div id="height" style="text-align: right; margin-right: 80px;">
						<div>
				  ...
				  <div class="form-group">
                        ...
                        <input value="<?php echo $width_standard; ?>" type="hidden" name="width_standard" id="width_standard" />
                        <input value="<?php echo $height_standard; ?>" type="hidden" name="height_standard" id="height_standard" />
                    </div>
			   </div>
		...
		<div class="col-12 col-lg-9 col-xl-7 drawimage ">
          <div style="float: left;position: relative;">
			   <i class="fa fa-spinner fa-spin"></i>
			  <div id="width">
				<div>
				  <label style="margin-right: 10px;" class="breiteText">BREITE IN MM</label>
				  <input id="width1" class="small" type="text" />
				  <input id="width2" class="small" type="text" />
				  <input id="width3" class="small" type="text" />
				</div>

                <div class="alert alert-dark warn" role="alert" id="warnW">
					This is a dark alert—check it out!
				</div>

			  </div>
			  <div class="top-canvas">
			     <button type="button" value="AUSSCHNITT WÄHLEN" class="btn button-cut versal" data-toggle="modal" data-target="#myModal"><i class="fa fa-crop"></i> Ausschnitt wählen</button>
			     <button style="display: none;" type="button" value="Experte" class="expert versal btn " data-toggle="tooltip" data-html="true" title="<b>Was ist der Expertenausschnitt?</b><br/><br/>Nachdem Sie sich für ein Motiv entschieden haben und die Maße eingetragen haben, können Sie diese Option wählen. Unsere Grafiker wählen für Sie den besten Ausschnitts des Motivs. Um diese Option wieder abzuwählen, klicken Sie bitte erneut auf Expertenausschnitt."><i class="fa fa-crop"></i> Experten-Ausschnitt</button>
			     <button type="button" value="AUSSCHNITT  GESPIEGELT" class="btn change-direction versal"><i class="fa fa-exchange"></i> Ausschnitt gespiegelt</button>
		...
		<div class="col-12 col-lg-12 col-xl-2 col-3-price " >
		   <div class="row">
			   <div class="col-xl-12">
				   	<p>PREIS</p>
				   <p class="price"></p>
				   <p>inkl. ges. MwSt.</p>
                   <p>Artikelnummer: <b><?php echo $name ?></b></p>
				</div>
        ...
        <img style="display:none" id="source_canvas" alt="" src="image/uploads/<?php echo $_GET['product_id'] ?>.png"/>
         <!-- Modal -->
	...
	<?php if ($products) { ?>
      ...
      <?php } ?>
	  <?php echo '<div class="text_configuration">' .html_entity_decode($text_configuration) . '</div>' ?>
...
$('#button-cart').on('click', function() {
	warn = drawImage.checkShowImageHeight(90);
    ...
    var anotherInformation = {};
    anotherInformation.material = nameMaterial;
    anotherInformation.plates = plates;
    anotherInformation.mirror = mirror;
    anotherInformation.expert = expert;
	...
	$.ajax({
		...
		data:{
                ...
                another_information: anotherInformation,
...
<script src="catalog/view/javascript/start.js?v=<?php echo rand() ?>" type="text/javascript"></script>
