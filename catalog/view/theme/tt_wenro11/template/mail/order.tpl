...
<div style="width: 680px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="https://shop.wandfreude.de/image/wandfreude.png" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none;" /></a>
    ...
    <?php foreach ($products as $product) { ?>
     <tr>
        ...
        <?php if($product['another_information'] == '') { ?>
          <td colspan="3" style="border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; padding: 7px;"><img width="550"  src='https://www.your-plate.de/image/<?php echo $product['image']; ?>'/></td>
        <?php } else { ?>
          <td width="30%"  style="border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; padding: 7px;"><img width="200"  src='https://www.your-plate.de/image/<?php echo $product['image']; ?>'/></td>
  ...
  <p style="margin-top: 0px; margin-bottom: 20px;"><?php echo $text_footer; ?></p>
    <p>Versandinformationen: <a href="https://shop.wandfreude.de/kontakt">shop.wandfreude.de/kontakt</a></p>
  <div>
    <br /><br /><b>Wandfreude</b><br />
    Konrad-Adenauer-Allee 107<br />
    61118 Bad Vilbel
    <br />

    Telefon: +4917666855208 <br />

    <a href="mailto:info@wandfreude.de" target="_blank">E-Mail: info@wandfreude.de</a><br />

    Geschäftsführer: Wandfreude GmbH<br />
