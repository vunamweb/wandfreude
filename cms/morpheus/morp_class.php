...
//// EDIT_SKRIPT
$um_wen_gehts 	= "Klassen konfigurieren";
$titel			= "Klassen konfigurieren";
///////////////////////////////////////////////////////////////////////////////////////
...
$arr_form = array(
	...
	array("class", "Bezeichnung", '<input type="Text" value="#v#" name="#n#" style="#s#">'),
...
#	$anz3 = "";
	...
	while ($row = mysqli_fetch_object($res)) {
		$edit = $row->$id;
		$echo .= '<li>
			<span class="fl100"><a href="?edit='.$edit.'"> '.$row->$anz.'</a></span>
...
elseif ($delete) {
	$sql = "DELETE FROM morp_class WHERE clid=$delete";
	$res = safe_query($sql);
}
