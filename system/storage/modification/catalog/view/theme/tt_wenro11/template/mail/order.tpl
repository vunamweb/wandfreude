...
<div style="width: 680px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="https://www.wandfreude.de/image/wandfreude_21.png" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none;" /></a>
  ...
  <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
    <thead>
      <tr>
        ...
        <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; background-color: #EFEFEF; font-weight: bold; text-align: left; padding: 7px; color: #222222;">ANZAHL PLATTEN</td>
      </tr>
    </thead>
    <?php foreach ($products as $product) { ?>
    <?php if($product['model'] == 'model') { ?>
     <tr>
        ...
        <?php if($product['another_information'] == '') { ?>
          <td colspan="3" style="border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; padding: 7px;"><img width="550"  src='https://www.wandfreude.de/image/<?php echo $product['image']; ?>'/></td>
        <?php } else { ?>
          <td width="30%"  style="border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; padding: 7px;"><img width="200"  src='https://www.wandfreude.de/image/<?php echo $product['image']; ?>'/></td>
  ...
  <p style="margin-top: 0px; margin-bottom: 20px;"><?php echo $text_footer; ?></p>
    <p>Versandinformationen: <a href="https://www.wandfreude.de/versand">www.wandfreude.de/versand</a></p>
  <div>
    <br /><br /><b>Wandfreude GmbH</b><br />
    Franz-Lehár-Weg 32<br />
    61118 Bad Vilbel
    <br />
    Telefon: 06101-9858619 <br />
    <a href="mailto:info@wandfreude.de" target="_blank">E-Mail: info@wandfreude.de</a><br />
    Geschäftsführer: Jürgen Wiedemann
  </div>
</div>
</body>
</html>
