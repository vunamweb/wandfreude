        ...
        <div class="col-2 col-sm-7">
		  ...
		  <?php if ($price) { ?>
			  <ul class="list-unstyled price-product">
				...
				<li>
				  ...
				  <span class="mwst">inkl. gesetzl. Mwst.</span>
				</li>
				<?php } else { ?>
          ...
          <ul class="list-unstyled">
			...
			<div class="form-group">
				<label class="control-label mr1" for="input-quantity"><?php echo $entry_qty; ?></label>
				<input type="text" name="quantity" value="<?php echo $minimum; ?>" size="2" id="input-quantity" class="form-control" />
				<input type="button" id="minus" value="-" class="form-control light" />
				<input type="button" id="plus" value="&#43;" class="form-control light"/>
				<br />
				<button class="button btn-pad" type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>"><!-- <i class="fa fa-shopping-basket"></i> --><span><?php echo $button_cart; ?></span></button>
				<button class="btn-wishlist" type="button" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');"><i class="fa fa-heart-o"></i></button>
				<button class="btn-compare" type="button" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"><i class="fa fa-signal"></i></button>
			</div>
