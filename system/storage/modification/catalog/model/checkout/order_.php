...
$this->session->data['gaenhpro_order_id'] = $order_id;
...
$text .= isset($data['stripecw_payment_information']) ? Customweb_Core_Util_Html::toText($data['stripecw_payment_information']) : '';
                ...
                //mail("vukynamkhtn@gmail.com", $subject, "this is mail test");
                ...
                $files2 = "./pdf/AGB-yourplate-GmbH.pdf";
                $files3 = "./pdf/Widerrufsrecht-yourplate-GmbH.pdf";
                $filename2= "AGB-yourplate-GmbH.pdf";
                $filename3 = "Widerrufsrecht-yourplate-GmbH.pdf";
