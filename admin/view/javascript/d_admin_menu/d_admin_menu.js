...
// opencart do this work
if (!sessionStorage.getItem('menu')) {
    $('#menu2 #dashboard').addClass('active');
} else {
    // Sets active and open to selected page in the left column menu.
    $('#menu2 a[href=\'' + sessionStorage.getItem('menu') + '\']').parents('li').addClass('active open');
}
$('#menu2 a[href=\'' + sessionStorage.getItem('menu') + '\']').parents('li > a').removeClass('collapsed');

$('#menu2 a[href=\'' + sessionStorage.getItem('menu') + '\']').parents('ul').addClass('in');
