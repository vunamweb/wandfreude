  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-ocfeaturedcategory" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-ocfeaturedcategory" class="form-horizontal">
          ...
          <div class="form-group">
              <label class="col-sm-2 control-label" for="input-showsub"><?php echo $entry_showsub ?></label>
              <div class="col-sm-10">
                <select  id="input-showsub" name="showsub" class="form-control">
                  <option value="0" <?php if($showsub==0) { ?> selected="selected" <?php } ?> >No</option>
                  <option value="1" <?php if($showsub==1) { ?> selected="selected" <?php } ?> >Yes</option>
                </select>
              </div>
          </div>
          <div class="form-group ">
            <label class="col-sm-2 control-label" for="input-showsubnumber"><?php echo $entry_showsubnumber ?></label>
            <div class="col-sm-10">
              <input type="text" name="showsubnumber" value="<?php echo $showsubnumber; ?>" placeholder="<?php echo $entry_showsubnumber; ?>" id="input-showsubnumber" class="form-control" />
            </div>
          </div>
          <div class="form-group">
