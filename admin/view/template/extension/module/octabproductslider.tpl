  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-octabproductslider" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-octabproductslider" class="form-horizontal">
            ...
            <div class="col-sm-10">
              <div class="well well-sm" style="height: 150px; overflow: auto;">
                <div class="checkbox">
                  ...
                  ?>
                  <label>
                    <input type="checkbox" name="types[]" value="bestseller" <?php if($bestseller_flag): ?>checked="checked"<?php endif; ?> /><?php echo $text_type_bestseller; ?>
                  </label>
                </div>
                <div class="checkbox">
                  <?php
                  if($types) {
                    $mostviewed_flag = false;
                    foreach($types as $type) {
                      if($type == 'mostviewed') {
                        $mostviewed_flag = true;
                      }
                    }
                  } else {
                    $mostviewed_flag = false;
                  ...
                  ?>
                  <label>
                    <input type="checkbox" name="types[]" value="mostviewed" <?php if($mostviewed_flag): ?>checked="checked"<?php endif; ?> /><?php echo $text_type_mostviewed; ?>
                  </label>
                </div>
                <div class="checkbox">
                  <?php
                  ...
                  ?>
                  <label>
                    <input type="checkbox" name="types[]" value="random" <?php if($random_flag): ?>checked="checked"<?php endif; ?> /><?php echo $text_type_random; ?>
                  </label>
                </div>
                <div class="checkbox">
                  <?php
                  ...
                  ?>
                  <label>
                    <input type="checkbox" name="types[]" value="special" <?php if($special_flag): ?>checked="checked"<?php endif; ?> /><?php echo $text_type_special; ?>
                  </label>
                </div>
                <div class="checkbox">
                  <?php
                  ...
                  ?>
                  <label>
                    <input type="checkbox" name="types[]" value="latest" <?php if($latest_flag): ?>checked="checked"<?php endif; ?> /><?php echo $text_type_latest; ?>
                  </label>
                </div>
              </div>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="rotator" id="input-status" class="form-control">
                <?php if ($rotator) { ?>
                <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                <option value="0"><?php echo $text_disabled; ?></option>
                <?php } else { ?>
