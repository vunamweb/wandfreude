...
<div id="content">
  ...
  <div class="container-fluid">
      ...
      <div class="panel-body">
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              <td class="text-left"><a href="<?php echo $product['href']; ?>"><?php echo ($product['model'] != 'model'? $product['name'] : 'Rückwand'); ?></a>
    ...
    <thead>
      <tr>
        <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD;  font-weight: bold; text-align: left; padding: 7px; color: #222222;">Name</td>
        <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD;  font-weight: bold; text-align: left; padding: 7px; color: #222222;">Bild</td>
        <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD;  font-weight: bold; text-align: left; padding: 7px; color: #222222;">GESPIEGELT</td>
        <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD;  font-weight: bold; text-align: left; padding: 7px; color: #222222;">Experte</td>
        <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD;  font-weight: bold; text-align: left; padding: 7px; color: #222222;">MATERIAL AUSWAHL</td>
        <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD;  font-weight: bold; text-align: left; padding: 7px; color: #222222;">Anzahl Rückwände</td>
        <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD;  font-weight: bold; text-align: left; padding: 7px; color: #222222;">Url of hires image</td>
      </tr>
    </thead>
    <?php foreach ($products as $product) { ?>
     <tr>
        <td width="20%" style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><?php echo ($product['model'] != 'model'? $product['name'] : 'Rückwand'); ?></td>
        <?php if($product['another_information'] == '') { ?>
          <td colspan="3" style="border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; padding: 7px;"><img style='width: 200px'  src='../image/<?php echo $product['image']; ?>'/></td>
        <?php } else { ?>
          <td width="20%"  style="border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; padding: 7px;"><img src='../image/<?php echo $product['image']; ?>'/></td>
          ...
          <td width="20%" style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;">
            <table>
...
$('#button-history').on('click', function() {
  ...
  $('.url_hire').each(function(e) {
    var id = 'data_' + $(this).attr('id');
  ...
  urls = JSON.stringify(urls);
	...
	$.ajax({
		...
		type: 'post',
		dataType: 'json',
		data: 'urls=' + urls + '&order_status_id=' + encodeURIComponent($('select[name=\'order_status_id\']').val()) + '&notify=' + ($('input[name=\'notify\']').prop('checked') ? 1 : 0) + '&override=' + ($('input[name=\'override\']').prop('checked') ? 1 : 0) + '&append=' + ($('input[name=\'append\']').prop('checked') ? 1 : 0) + '&comment=' + encodeURIComponent($('textarea[name=\'comment\']').val()),
		beforeSend: function() {
