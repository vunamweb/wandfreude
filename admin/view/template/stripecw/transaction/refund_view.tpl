...
<div id="content">
    ...
    <div class="panel panel-default">
			...
			<table class="table table-bordered table-hover">
				<tr>
					<td><?php echo StripeCw_Language::_('Refund ID') ?></td>
					<td><?php echo $refund->getRefundId(); ?></td>
				</tr>

				<tr>
					<td><?php echo StripeCw_Language::_('Refund Date') ?></td>
					<td><?php echo $refund->getRefundedDate()->format(Customweb_Core_Util_System::getDefaultDateTimeFormat()); ?></td>
				</tr>
				<tr>
					<td><?php echo StripeCw_Language::_('Refund Amount') ?></td>
			...
			<h2><?php echo StripeCw_Language::_('Refunded Items'); ?></h2>
			<table class="table table-bordered table-hover">
				<thead>
					<tr>
