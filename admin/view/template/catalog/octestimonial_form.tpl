            ...
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
					<div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="testimonial_description[customer_name]" size="100" value="<?php echo isset($testimonial_description['customer_name']) ? $testimonial_description['customer_name'] : ''; ?>" />
                            <?php if (isset($error)) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                                <textarea class="form-control" name="testimonial_description[content]" id="content"><?php echo isset($testimonial_description['content']) ? $testimonial_description['content'] : ''; ?></textarea>
                        </div>
                    </div>
