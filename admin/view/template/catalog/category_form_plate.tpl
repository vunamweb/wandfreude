          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group required hide">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="category_description[<?php echo $language['language_id']; ?>][meta_title]" value="category" placeholder="<?php echo $entry_meta_title; ?>" id="input-meta-title<?php echo $language['language_id']; ?>" class="form-control" />
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-height_standard"><span data-toggle="tooltip" title="Height standard">Height standard</span></label>
                <div class="col-sm-10">
                  <input type="text" name="height_standard" value="<?php echo $height_standard; ?>" placeholder="Height standard" id="input-height_standard" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-width_standard"><span data-toggle="tooltip" title="width standard">Width standard</span></label>
                <div class="col-sm-10">
                  <input type="text" name="width_standard" value="<?php echo $width_standard; ?>" placeholder="Width standard" id="input-width_standard" class="form-control" />
                </div>
              </div>
              <div class="form-group">
