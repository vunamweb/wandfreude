...
class ControllerCatalogOctestimonial extends Controller {
	private $error = array();
  	...
  	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->response->redirect($this->url->link('catalog/octestimonial', 'token=' . $this->session->data['token'] . $url, true));
    	}
    ...
    protected function getList() {
        ...
        $data['insert'] = $this->url->link('catalog/octestimonial/insert', 'token=' . $this->session->data['token'] . $url, true);
        $data['delete'] = $this->url->link('catalog/octestimonial/delete', 'token=' . $this->session->data['token'] . $url, true);

		foreach ($results as $result) {
			$action = array();
			$action[] = array(
				'text' => $this->language->get('text_edit'),
				'href' => $this->url->link('catalog/octestimonial/update', 'token=' . $this->session->data['token'] . '&testimonial_id=' . $result['testimonial_id'], true)
			);
      		$data['testimonials'][] = array(
		...
		$pagination->url = $this->url->link('catalog/octestimonial', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
        ...
        $this->response->setOutput($this->load->view('catalog/octestimonial_list.tpl', $data));
  	}
  	...
  	private function getForm() {
		...
		if (isset($this->request->get['order'])) {
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
       		'text'      => $this->language->get('heading_title'),
			'href'      => $this->url->link('catalog/octestimonial', 'token=' . $this->session->data['token'] . $url, true),
      		'separator' => ' / '
   		);


		if (!isset($this->request->get['testimonial_id'])) {
			$data['action'] = $this->url->link('catalog/octestimonial/insert', 'token=' . $this->session->data['token'], true);
		} else {
			$data['action'] = $this->url->link('catalog/octestimonial/update', 'token=' . $this->session->data['token'] . '&testimonial_id=' . $this->request->get['testimonial_id'], true);
		}
		
		$data['cancel'] = $this->url->link('catalog/octestimonial', 'token=' . $this->session->data['token'], true);
        ...
        $this->response->setOutput($this->load->view('catalog/octestimonial_form.tpl', $data));
  	}
